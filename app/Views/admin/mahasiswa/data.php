<div class="container">
    ...
    <div style="margin-top: 4rem; margin-bottom: 4rem">
        <div style="margin: 1rem">
            ...
            <a class="btn red" href="<?php echo site_url('admin/mahasiswa/reset'); ?>" onclick="return confirm('Apakah anda yakin? Semua data mahasiswa akan terhapus jika dilanjut')"><i class="fa fa-redo left"></i> RESET MAHASISWA</a>
        </div>
