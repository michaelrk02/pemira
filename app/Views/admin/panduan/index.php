    ...
    <div style="margin: 1rem">
        ...
        <div>
            <ol>
                ...
                <li><b>Tambah Data Sesi.</b> Sebelum pemilihan, sesi atau jadwal tiap prodi harus diatur terlebih dahulu. Anda dapat <a target="_blank" href="<?php echo site_url('admin/sesi/view'); ?>">menambahkan sesi</a> lalu <a target="_blank" href="<?php echo site_url('admin/prodi/view'); ?>">memasukkannya ke prodi</a> sesuai dengan jadwal yang ditetapkan oleh panitia. Tiap prodi bisa menempati beberapa sesi dan tiap sesi bisa ditempati beberapa prodi</li>
