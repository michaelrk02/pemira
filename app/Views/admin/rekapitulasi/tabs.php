<div class="container">
    ...
    <div>
        <ul class="tabs">
            ...
            <li class="tab col"><a <?php echo uri_string() === 'admin/rekapitulasi/partai' ? 'class="active"' : ''; ?> target="_self" href="<?php echo site_url('admin/rekapitulasi/partai'); ?>">PARTAI</a></li>
